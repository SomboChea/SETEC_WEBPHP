            ...
            <div class="col-md-8 col-xs-12" style="margin:0;padding:0">
                <div class="block-detail">
                    <div class="detail-header-title">
                        <h3>iPhone 7 Plus​ ​ផ្ទុះ​ឆេះ​មួយ​ករណី​ទៀត​ហើយ!</h3>
                        <div class="pub-date">
                            <p class="date"><i class="fa fa-clock-o" aria-hidden="true"></i> ថ្ងៃនេះ ម៉ោង 10:17</p>
                            <p class="comment"><i class="fa fa-comment-o" aria-hidden="true"></i> ចំនួនមតិ 0</p>
                        </div>
                        <br />
                        <hr />
                    </div>
                    ...
                    <div class="detail-content">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="row">
                                    <div class="col-md-4"><a href="https://www.facebook.com/"><i class="fa fa-facebook-square fa-3x" aria-hidden="true" ></i></a></div>
                                    <div class="col-md-4"><a href="https://twitter.com/"><i class="fa fa-twitter-square fa-3x" aria-hidden="true"></i></a>
                                    </div>
                                    <div class="col-md-4"><a href="#"><i class="fa fa-share-alt-square fa-3x" aria-hidden="true"></i></a></div>
                                </div>
                        ...
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/pPeTjnGXGGE" frameborder="0" allowfullscreen class="video"></iframe>
                        <br/>
                    ...
                    <div class="related">
                        ...
                        <div class="block-related .visible-md-* .hidden-sm">
                            <div class="item">
                                <ul id="content-slider-related" class="content-slider">
                                    <li>
                                        <div class="big-thumb">
                                            <a href="#">
            ...
            <div class="col-md-4 col-xs-12" style="margin:0;padding:0">
                <div class="sidebar">
                    ...
                    <div class="recent-post">
                        ...
                        <div class="blok-recent-post-item">
